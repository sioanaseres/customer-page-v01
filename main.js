...
const customersSortedAscRelevance = [...customers.data].sort(
  (a, b) => a.relevance - b.relevance
);
const customersSortedDescRelevance = [...customers.data].sort(
  (a, b) => b.relevance - a.relevance
);

const customersSortedAscAlphabetical = [...customers.data].sort((a, b) =>
  a.name < b.name ? -1 : 1
);
const customersSortedDescAlphabetical = [...customers.data].sort((a, b) =>
  a.name > b.name ? -1 : 1
);
